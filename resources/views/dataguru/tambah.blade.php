        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <form action="data-guru-insert" class="row g-3 py-1 px-4" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <textarea name="alamat" class="form-control rounded-3" style="height: 100px" required>{{ old('informasitambahan') }}</textarea>
                            </div>
                        </div>
