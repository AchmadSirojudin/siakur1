        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <form action="/data-guru-update/{{ $guru->id }}" class="row g-3 py-1 px-4" method="post"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)" name="nip"
                                    class="form-control rounded-3" required value="{{ $guru->NIP }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="Laki-laki"
                                    value="Laki-laki" {{ $guru->jk == 'Laki-laki' ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="Laki-laki"
                                    value="Perempuan" {{ $guru->jk == 'Perempuan' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="tempatlahir" class="form-control rounded-3" id="inputEmail4"
                                    required value="{{ $guru->tempatlahir }}"
                                    {{ $errors->has('tempatlahir') ? 'autofocus="true"' : '' }}>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" maxlength="13" onkeypress="return hanyaAngka(event)" name="notelp"
                                    class="form-control rounded-3" id="inputEmail4" required value="{{ $guru->notelp }}"
                                ...
                                <div class="input-group">
                                    <select class="form-select rounded-3 form-control-lg text-sm"
                                        ...
                                        <option value="Kristen Protestan"
                                            {{ $guru->agama == 'Kristen Protestan' ? 'Selected' : '' }}>Kristen Protestan
                                        </option>
                                        <option value="Kristen Katolik"
                                            {{ $guru->agama == 'Kristen Katolik' ? 'Selected' : '' }}>Kristen Katolik
                                        </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control rounded-3 text-sm" name="foto" type="file"
                                ...
                                value="{{ $guru->foto }}" {{ $errors->has('foto') ? 'autofocus="true"' : '' }}>
                            <img src=" {{ asset('assets') }}/img/pegawai/{{ $guru->foto }}" id="file-preview-poster"
                                alt="..." class="img-thumbnail mt-2" width="50%">
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Alamat</label>
                            <div class="input-group">
                                <textarea name="alamat" class="form-control rounded-3" style="height: 100px" required>{{ $guru->alamat }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col text-right">
                            ...
                            <a href="/data-guru" type="button" class="btn btn-danger text-sm rounded-3"
