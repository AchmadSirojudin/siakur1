...
@section('breadcrumbs')
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/data-jadwalmengajar-guru">Data Guru</a>
        </li>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <a href="/data-jadwalmengajar-guru" type="button" id="btntambah"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 pb-2">
                                                                ...
                                                                <input type="text" class="form-control" name="keterangan"
                                                                    id="inputPassword4" value="{{ $j->keterangan }}">
                                                            </div>
                                                        </div>
