        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <form action="/data-pegawai-update/{{ $user->id }}" class="row g-3 py-1 px-4" method="post"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" onkeypress="return hanyaAngka(event)" name="nip"
                                    class="form-control rounded-3" required value="{{ $user->NIP }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="Laki-laki"
                                    value="Laki-laki" {{ $user->jk == 'Laki-laki' ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="Laki-laki"
                                    value="Perempuan" {{ $user->jk == 'Perempuan' ? 'checked' : '' }}>
                            ...
                            <div class="input-group">
                                <select class="form-select rounded-3 form-control-lg text-sm"
                                    ...
                                    <option value="Kepala Sekolah"
                                        {{ $user->jabatan == 'Kepala Sekolah' ? 'Selected' : '' }}>
                                        Kepala Sekolah
                                    </option>
                                    <option value="Wakil Kepala Sekolah"
                                        {{ $user->jabatan == 'Wakil Kepala Sekolah' ? 'Selected' : '' }}>
                                        Wakil Kepala Sekolah
                                    </option>
                                    <option value="Tata Usaha" {{ $user->jabatan == 'Tata Usaha' ? 'Selected' : '' }}>
                                        Tata Usaha
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="tempatlahir" class="form-control rounded-3" id="inputEmail4"
                                    required value="{{ $user->tempatlahir }}"
                                    {{ $errors->has('tempatlahir') ? 'autofocus="true"' : '' }}>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" maxlength="13" onkeypress="return hanyaAngka(event)" name="notelp"
                                    class="form-control rounded-3" id="inputEmail4" required value="{{ $user->notelp }}"
                                ...
                                <div class="input-group">
                                    <select class="form-select rounded-3 form-control-lg text-sm"
                                        ...
                                        <option value="Kristen Protestan"
                                            {{ $user->agama == 'Kristen Protestan' ? 'Selected' : '' }}>Kristen Protestan
                                        </option>
                                        <option value="Kristen Katolik"
                                            {{ $user->agama == 'Kristen Katolik' ? 'Selected' : '' }}>Kristen Katolik
                                        </option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <textarea name="alamat" class="form-control rounded-3" style="height: 100px" required>{{ $user->alamat }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input class="form-control rounded-3 text-sm" name="foto" type="file"
                                ...
                                value="{{ $user->foto }}" {{ $errors->has('foto') ? 'autofocus="true"' : '' }}>
                            <img src=" {{ asset('assets') }}/img/pegawai/{{ $user->foto }}" id="file-preview-poster"
